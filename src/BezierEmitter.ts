...
import { BezierParticle } from './BezierParticle';

export interface BezierEmitterConfig extends ParticleEmitterConfig{

}

export class BezierEmitter extends ParticleEmitter<BezierEmitterConfig> {
    emitParticles(x: number, y: number, count: number) {
